...
<div class="panel-heading">ข้อมูลโทรศัพท์ทั้งหมด  </div>                     
			...
			<table width="100%" class="table table-striped table-bordered table-hover" id="datatable-responsive">
              <tbody>
                ...
                <tr>
                  <td >รายงานการซ่อม :</td>
                  <td ><?=$objResult['service_report'];?></td>
                </tr>
                <tr>
                  <td class="table_td">ผู้ดูแล :</td>
                  <td class="detailtext"><?=$objResult['supervisor'];?></td>
                </tr>
                <tr>
                  <td >อัพเดท :</td>
                  <td ><?php
                ...
                <tr>
                  <td>&nbsp;</td>
                  <td ><a href="report_rehearsal.php?id=<?=$_GET['id']?>"><img src="../images/print.png" title="ปริ้น" width="50" height="50">พิมพ์เอกสาร</a></td>
                </tr>
              </tbody>
			</table>
			</center>
