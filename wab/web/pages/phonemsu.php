...
<!-- เริ่มเขียนหน้าตาตรงนี้-->
 <div id="global">
            <div class="container-fluid cm-container-white">
                <h2 style="margin-top:0;">ข้อมูลโทรศัพท์ภายใน 4 หลัก</h2> 
...
<div class="panel-heading">ข้อมูลโทรศัพท์ภายใน  </div>   
		...
		<table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                ...
                <?php
					include('connect.php');
					$count = 0;
						$strSQL =  mysql_query("SELECT * FROM `telephone` where `telephone`. `group` = 'ภายใน' order by p_id ASC") or die ("Select Error");
