...
<div class="panel-heading">ข้อมูลโทรศัพท์ภายใน  </div>   
		...
		<table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                ...
                <?php
					include('connect.php');
					$count = 0;
						$strSQL =  mysql_query("SELECT * FROM `telephone` where `telephone`. `group` = 'IP Phone'  order by p_id ASC") or die ("Select Error");
