...
<!-- เริ่มเขียนหน้าตาตรงนี้-->
 <div id="global">
            <div class="container-fluid cm-container-white">
                <h2 style="margin-top:0;">ข้อมูลโทรศัพท์เบอร์ตรง TOT</h2> 
                <p>โทรศัพท์ภายในมหาวิทยาลัยมหาสารคาม เบอร์กลางมหาวิทยาลัย โทร. 043-754333 ,043-754321-40</p>
            </div>
<div class="container-fluid">
 <div class="panel panel-default">
<div class="panel-heading">ข้อมูลโทรศัพท์เบอร์ตรง TOT  </div>   
		...
		<table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                ...
                <?php
					include('connect.php');
					$count = 0;
						$strSQL =  mysql_query("SELECT * FROM `telephone` where `telephone`. `group` = 'ภายนอก' order by p_id ASC") or die ("Select Error");
